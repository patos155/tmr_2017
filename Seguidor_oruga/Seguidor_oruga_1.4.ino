 ...
 // /*
  ...
  if(l2==bco && l3==neg && l4==bco){
   ...
   if(l1==neg && l5==neg){
      ...
      enc_vde_1=0;
      enc_vde_2=0;
      //se aplican lecturas continuas para lectura de color
      ...
      color;
      delay(5);
     //Senor 1 izquierdo (giro a la izquierda)
     cont=cont+1;
     //sensor 2 y sensor 1(giro de 180°)a la derecha
    ...
    //sensor 2 derecha (giro a la derecha)
     if(enc_vde_2==1){
      motori.setSpeed(125);
      motori.run(FORWARD);
      motord.setSpeed(110);
     ...
     if(cont==5){// color no encontrado avanza 
      motori.setSpeed(100);
      motori.run(FORWARD);
      motord.setSpeed(100);
      motord.run(FORWARD);
